...
```mermaid
graph TD
    Cloud[Cloud Computing] --> Fund[Fundamentals]
    Cloud --> Prov[Providers]
    Cloud --> Serv[Services]
    Cloud --> Arch[Architecture]

    Fund --> Virt[Virtualization]
    Fund --> Net[Cloud Networking]
